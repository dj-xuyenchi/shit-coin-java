...
public class DataTransaction {
    ...
    public DataTransaction(int blockCount, String transactionId, SourceMoney nguoiChuyenTien, ReceiverMoney nguoiNhanTien, String transactionDateTime,String transactionValue, String detailTransaction) {
    ...
    public int getRemakeHashKey() {
        return remakeHashKey;
    }

    public void setRemakeHashKey(int remakeHashKey) {
        this.remakeHashKey = remakeHashKey;
    }
    ...
    private String calculHash() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        ...
        String temp = blockCount + preHash + transactionId + nguoiChuyenTien.toString() + nguoiNhanTien.toString() + transactionDateTime + detailTransaction + remakeHashKey+transactionValue;
